...
train_number = 1095820#1091215 #1124823
validation_num = 1124823-1095820
...
try:
    while True:
        ...
        if parameters[0].get_value()[0][0]!=parameters[0].get_value()[0][0]:
            ...
            f_P_bomb = file('parameter_RNN_1109_bombPrevent.txt', 'wb')
...
f_P = file('parameter_RNN_batch_1109_noRMS.txt', 'wb')
